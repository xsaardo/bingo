...
<script lang="ts">
  ...
  let {
    ...
    size,
    cellSize,
    cardClass = 'card-organic p-2 sm:p-3 md:p-4 relative flex flex-col',
    cardStyle,
    titleClass = 'font-bold text-primary text-center shrink-0 pb-2 sm:pb-3 truncate uppercase tracking-tight',
