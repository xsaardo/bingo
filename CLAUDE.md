...
Rule #1: If you want exception to ANY rule, YOU MUST STOP and get explicit permission from Cuong first. BREAKING THE LETTER OR SPIRIT OF THE RULES IS FAILURE.
...
- You MUST think of and address your human partner as "Cuong" at all times

## Our relationship

- We're colleagues working together as "Cuong" and "Claude" - no formal hierarchy.
...
- YOU MUST get Cuong's explicit approval before implementing ANY backward compatibility.
- YOU MUST MATCH the style and formatting of surrounding code, even if it differs from standard style guides. Consistency within a file trumps external standards.
- YOU MUST NOT manually change whitespace that does not affect execution or output. Otherwise, use a formatting tool.
- Fix broken things immediately when you find them. Don't ask permission to fix bugs.
- Document your progress in IMPL.md step by step as you build, in such a meticulous way that anyone can continue your work after you - this will prevent network outages from stopping work. Also, if you get stuck on something or have questions, rather than build on your assumptions, pause the process and ask me
...
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Cuong about them.
...
- You MUST NEVER discard tasks from your TodoWrite todo list without Cuong's explicit approval
...
│   │   ├── BingoBoard.svelte          # Main board component
│   │   ├── BoardCard.svelte           # Board list item
│   │   ├── BoardSizeSelector.svelte   # Size selection UI
│   │   ├── ConfirmationModal.svelte   # Reusable confirmation dialog
│   │   ├── CreateBoardModal.svelte    # New board creation
│   │   ├── DeleteBoardModal.svelte    # Board deletion confirmation
│   │   ├── ErrorAlert.svelte          # Error display component
│   │   ├── GoalModal.svelte           # Goal editing dialog
│   │   ├── GoalSidebar.svelte         # Slide-out notes sidebar
│   │   ├── GoalSquare.svelte          # Individual goal cell
│   │   ├── MagicLinkForm.svelte       # Email authentication
│   │   └── UserMenu.svelte            # User menu with logout
│   ├── stores/         # Svelte stores for state management
│   │   ├── auth.ts            # Authentication state
│   │   ├── board.ts           # Legacy board store
│   │   ├── boards.ts          # Multi-board management
...
└── routes/
    ...
    ├── auth/
    │   ├── callback/+page.svelte       # Magic link callback
    │   ├── login/+page.svelte          # Login page
    │   └── logout/+page.svelte         # Logout handler
    ├── boards/[id]/+page.svelte        # Individual board view
    └── dashboard/+page.svelte          # Board management dashboard
```

### Data Model

The app supports multi-user boards with authentication:
